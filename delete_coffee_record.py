...
def main():
    #create a bool variable to use a s a flag.
    found = False
    ...
    while descr != '':
        ...
        #if theis is not the record to delete, then write it to
        #the temporary file.
        if descr != search:
    ...
    #if the search value was not found in teh file, display  a message.
    if found:
